...
import { JhipsterSampleGatewayApplicationSharedModule } from 'app/shared';
import { JhipsterSampleGatewayApplicationCoreModule } from 'app/core';
import { JhipsterSampleGatewayApplicationAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        ...
        JhipsterSampleGatewayApplicationSharedModule.forRoot(),
        JhipsterSampleGatewayApplicationCoreModule,
        ...
        JhipsterSampleGatewayApplicationAppRoutingModule
    ],
